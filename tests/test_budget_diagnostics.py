...
def test_v4_migration_backfills_existing_run_budget_snapshot(tmp_path):
    ...
    with sqlite3.connect(repository.database_path) as connection:
        for table in (
            "agent_events", "mcp_servers", "skills",
            "memory_candidates", "memories", "agent_messages", "telemetry_drops", "error_artifacts", "errors", "budget_entries",
        ...
        connection.execute("DROP TABLE IF EXISTS search_sequence")
